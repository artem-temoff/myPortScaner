...
public class Main {
    ...
    static List<PortScanner> workers = new ArrayList<PortScanner>(MAX_THREADS);
        ...
        if (allPorts.size()/MIN_PORTS_PER_THREAD > MAX_THREADS ) {
            ...
            for (int i=0,counter=0; i<allPorts.size();i++,counter++) {
                if (counter<PORTS_PER_THREAD) {
                    ...
                    PortScanner psw = new PortScanner();
...
///////////////////////////////////////////////////////////////////////////////////
    ...
    static void usage() {
        System.out.println("PortScanner usage: ");
